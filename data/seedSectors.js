...
const seedSectorsAndZipcodes = async () => {
  ...
  try {
    ...
    const zipToSectorMapping = [
      ...
      { zipcode: 60, name: 'Oise', sector: 'Nord' },
      ...
      { zipcode: 77, name: 'Seine et Marne', sector: 'IdF' },
      { zipcode: 78, name: 'Yvelines', sector: 'IdF' },
      { zipcode: 79, name: 'Deux Sèvres', sector: 'Grand Ouest' },
      { zipcode: 80, name: 'Picardie', sector: 'Nord' },
      { zipcode: 83, name: 'Var', sector: 'Sud Est' },
      { zipcode: 84, name: 'Vaucluse', sector: 'Sud Est' },
      { zipcode: 85, name: 'Vendée', sector: 'Grand Ouest' },
      { zipcode: 86, name: 'Vienne', sector: 'Grand Ouest' },
      { zipcode: 87, name: 'Haute Vienne', sector: 'Grand Ouest' },
      { zipcode: 88, name: 'Vosges', sector: 'Grand Est' },
      { zipcode: 89, name: 'Yonne', sector: 'Bourgogne / Franche Comté' },
      {
        zipcode: 90,
        name: 'Territoire de Belfort',
        sector: 'Bourgogne / Franche Comté',
      },
      { zipcode: 91, name: 'Essonne', sector: 'IdF' },
      { zipcode: 92, name: 'Hauts de Seine', sector: 'IdF' },
      { zipcode: 93, name: 'Seine saint Denis', sector: 'IdF' },
      { zipcode: 94, name: 'Val de Marne', sector: 'IdF' },
